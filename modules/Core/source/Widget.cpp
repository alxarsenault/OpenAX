...
namespace widget {
	...
	void Info::SetAttributes(const ax::StringPairVector& attributes)
	{
	...
	void Component::SetInfo(const ax::StringPairVector& att)
	{
	}
	...
	void Component::SetBuilderAttributes(const ax::StringPairVector& att)
	{
	}

	ax::StringPairVector Component::GetBuilderAttributes()
	{
		return ax::StringPairVector();
	}
}
}