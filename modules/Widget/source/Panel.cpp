...
Panel::Info::Info(const StringPairVector& attributes)
{
...
ax::StringPairVector Panel::Component::GetBuilderAttributes()
{
...
//				std::string name = child.GetAttribute("name");
				...
				if (builder == nullptr) {
					ax::Error("Panel builder", buider_name, "doesn't exist.");
